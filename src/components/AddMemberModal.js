  ...
  return (
    ...
    <div className="animated fadeIn modal fixed w-full h-full top-0 left-0 flex items-center justify-center">
      ...
      <div className="modal-container bg-gray-100 w-11/12 md:max-w-md mx-auto rounded-md shadow-lg z-50 overflow-y-auto">
        ...
        <div onClick={(e) => props.clickToToggle(props.componentName, e)} className="modal-close absolute top-0 right-0 cursor-pointer flex flex-col items-center mt-4 mr-4 text-white text-sm z-50">
        ...
        <div className="modal-content py-4 text-center px-6">
          ...
          <div className="flex justify-between items-center pb-3">
            ...
            <div onClick={(e) => props.clickToToggle(props.componentName, e)} className="modal-close cursor-pointer z-50">
