  ...
  return (
    ...
    <div className="animated fadeIn modal fixed w-full h-full top-0 left-0 flex items-center justify-center">
      <div className="modal-overlay absolute w-full h-full bg-gray-800 opacity-75"></div>
        ...
        <div onClick={(e) => toggleModal(false, e)} className="modal-close absolute top-0 right-0 cursor-pointer flex flex-col items-center mt-4 mr-4 text-white text-sm z-50">
        ...
        {renderStatus.modalView === 'AddMemberModal' && <AddMemberModal toggleModal={toggleModal} />}
